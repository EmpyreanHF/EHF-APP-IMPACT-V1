...
(function EmpyreanFixFinal() {
    ...
    (function fixAdminDisbursementWalletType(){
        ...
        document.addEventListener('click',function(e){ var t=e.target; if(t.closest&&(t.closest('[data-tab="admin-disburse-tab"]')||t.closest('#admin-disburse-tab')||(t.dataset&&t.dataset.tab==='admin-disburse-tab'))) setTimeout(function(){ _patchPanel(); _patchHistoryTable(); },250); });
    ...
    (function fixDashboardBizPostsSlider(){
        ...
        function _init(){ if(typeof window.renderDashboardBusinesses==='function') try{window.renderDashboardBusinesses();}catch(e){} _loadPosts(); }
